.PHONY: test-mock test-live gate-week8 gate-week9 gate-week10 gate-week11 test-adversarial bench-quality check-budget bench-runtime bench-memory bench-continuity
...
gate-week11:
	bash scripts/run_week11_quick_iteration_acceptance.sh
...
bench-memory:
	python3 scripts/benchmark_memory_effectiveness.py --out governance/audits/memory_effectiveness_benchmark.json

bench-continuity:
	python3 scripts/benchmark_runtime_continuity.py --out governance/audits/runtime_continuity_benchmark.json
